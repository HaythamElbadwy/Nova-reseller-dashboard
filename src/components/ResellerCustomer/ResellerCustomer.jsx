...
export default function ResellerCustomer() {
  ...
  const getResellerCustomer = async (page) => {
    ...
    try {
      const response = await fetch(`https://novatv.onrender.com/reseller/getSubscriptions?page=${page}`, {
        method: 'GET',
        headers: {
  ...
  const addNewSubscription = async () => {
    ...
    setIsLoading(true)
    try {
      const response = await fetch(`https://novatv.onrender.com/reseller/newSubscription`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'authorization': `novON0${localStorage.getItem('authToken')}`
  ...
  const getSearch = async (macAddress) => {
    ...
    try {
      const response = await fetch(`https://novatv.onrender.com/reseller/searchByMac?macAddress=${macAddress}&type=reseller`, {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
          'authorization': `novON0${localStorage.getItem('authToken')}`
